...
const Medication = () => {
    ...
    const [tableData, setTableData] = useState([
        { id: 1, tablet: 'John Doe', fn: 1, an:0, night:1 },
        { id: 2, tablet: 'Jane Smith', fn: 0, an:0, night:1 },
      ]);
                        ...
                        <Table striped bordered hover>
                            ...
                            <tbody>
                                {tableData.map((row,index)=>(
                                    <tr>
                                    <td>{index+1}</td>
                                    <td contenteditable="true" style={{maxWidth:'150px'}} onChange={(e)=>handleEdit(index,'tablet',e.target.value)}>{row.tablet}</td>
                                    ...
                                    <td><Button variant='danger btn-sm' onClick={()=>deleteRow(index)}>Delete</Button></td>
                                </tr>
                                ))}
                            </tbody>
                        </Table>
